...
specifically we use the R-tree implementation from Boost.Geometry \cite{web_boost_geometry}.
The graph and the R-tree are used in the path-finding step described in section \ref{sec:exepath}.
