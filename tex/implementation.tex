...
the instrument geometry and states.
State changes in the class, for example the occurence of a collision, are signalled to the outside world
...
\section{Summary}
In summary, we presented a two-part path-finding algorithm and its implementation, which generates an angular
