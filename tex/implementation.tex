...
to the crystal rocking angle, where only the crystal is turned while keeping the scattering angle constant \cite[p. 87]{Shirane2002} (see chapter \ref{ch:xtal}).
