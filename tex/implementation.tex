...
\begin{figure*}
	\includegraphics[width = 0.49 \textwidth]{figures/simplification_contour}
	\hspace{0.1cm}
	\includegraphics[width = 0.49 \textwidth]{figures/simplification_linesegments}

	\vspace{0.25cm}

	\includegraphics[width = 0.49 \textwidth]{figures/simplification_step1}
	\hspace{0.1cm}
	\includegraphics[width = 0.49 \textwidth]{figures/simplification_step2}
