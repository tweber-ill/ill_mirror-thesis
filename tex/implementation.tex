...
For processing and storing the image of the quantised configuration space, we originally
used the \textit{Boost.GIL} library \cite{web_boost_gil}, but switched to a bespoke solution after
having multithreading issues with that library.
...
\cite{web_boost_polygon, Simonson2009} C++ library together with code
for iterating points on a quadratic bisector \cite{web_boost_polygon_voronoi_visual_utils} for one,
