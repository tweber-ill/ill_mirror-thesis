...
Specifically, the latest version 20 of the C++ standard \cite{ISOCPP20}
together with the Boost C++ template libraries \cite{web_boost}
was employed in the creation of the software. 
The source code for the implementation can be found in the directory \lstinline|./src/core| 
together with the library routines in \lstinline|./src/libs| of the repository at 
...
chapter \ref{ch:online} for more details.
...
(see chapter \ref{sec:indextrees}).
...
The R* tree implementation proved far more performant than alternate tests using a k-d tree.
