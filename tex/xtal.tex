...
the user, not the raw instrument angles. A path-finding system for triple-axis spectrometers thus has to know both. 
...
essential concepts in computer science before putting everything together in a path-finding algorithm.
