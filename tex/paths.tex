...
An example run of the algorithm is shown in Fig. \ref{fig:pledge}.
\begin{figure}[htb]
	\centering
	\includegraphics[width = 0.33 \textwidth]{figures/pledge.pdf}
	\caption[Pledge algorithm.]{
		Finding a path out of a maze using Pledge's algorithm.}
	\label{fig:pledge}
\end{figure}
