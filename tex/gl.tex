...
Rendering in \textit{OpenGL} is performed using shaders -- small \textit{C}-like programs that are executed on 
the GPU -- where a minimum rendering pipeline consists of at least a vertex and a fragment shader. 
