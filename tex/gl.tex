...
namely the coordinate system of the 3-d object, a global coordinate system common for all objects in the scene, the
...
The transformation inverse to Eq. \ref{eq:gl_mvp} is also of importance to be able to select objects in the
