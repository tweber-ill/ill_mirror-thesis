...
We show each step of the algorithm by finding the shortest paths from start point $v_1$ of
the graph in Fig. \ref{fig:example_graph}.
...
\begin{table}[h]
	...
	\item Iteration 1: Having treated outgoing edges from $v_1$ (top of heap) to $v_2$, $v_4$, and $v_5$,
		all three leading to shorter paths.
	...
	\item Iteration 2: Having treated outgoing edges from $v_2$ to $v_3$ and $v_4$,
		both leading to shorter paths.
	...
	\item Iteration 3: Having treated outgoing edges from $v_3$ to $v_4$ and $v_5$,
		both leading to shorter paths.
	...
	\item Iteration 4: Having treated outgoing edges from $v_4$ to $v_2$ and $v_5$,
		no shorter paths.
	...
	\begin{tabular}{|c|ccc|}
			\hline
			     Heap & $v_5$ & $v_4$ & $v_2$ \tabularnewline
			\hline
			Distances &  $10$  &  $9$ &  $1$ \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\item Iteration 2: No outgoing edges from $v_5$.
	
	\begin{tabular}{|c|cc|}
			\hline
			     Heap & $v_2$ & $v_4$  \tabularnewline
			\hline
			Distances &  $1$  &  $9$  \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\item Iteration 3: Having treated outgoing edges from $v_2$ to $v_3$ and $v_4$,
		both leading to shorter paths.
	
	\begin{tabular}{|c|cc|}
			\hline
			     Heap & $v_4$ & $v_3$  \tabularnewline
			\hline
			Distances &  $8$  &  $4$   \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\begin{tabular}{|c|c|}
			\hline
			     Heap & $v_3$ \tabularnewline
			\hline
			Distances &  $4$   \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\item Iteration 5: Having treated outgoing edges from $v_3$ to $v_4$ and $v_5$,
		both leading to shorter paths.
	
	\begin{tabular}{|c|cc|}
			\hline
			     Heap & $v_5$ & $v_4$ \tabularnewline
			\hline
			Distances &  $6$  &  $5$   \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\item Iteration 6: No outgoing edges from $v_5$.
	
	\begin{tabular}{|c|c|}
			\hline
			     Heap & $v_4$ \tabularnewline
			\hline
			Distances &  $5$   \tabularnewline
			\hline
	\end{tabular}\\
	\begin{tabular}{|c|ccccc|}
			\hline
	...
	\item Finalisation: Having treated outgoing edges from $v_4$ to $v_2$ and $v_5$,
		no shorter paths.
