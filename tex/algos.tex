...
\paragraph{BSP tree}
The BSP or \textit{binary space partitioning} tree recursively divides the $n$ dimensional vector 
space it operates on into two half-spaces. These two half-spaces respectively lie left and right of 
an $n-1$ dimensional splitting hyperplane. The hyperplane is usually chosen so that each of the 
