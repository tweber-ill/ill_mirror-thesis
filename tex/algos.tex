...
The curves show the times needed to calculate the Voronoi diagrams for random non-intersecting line segments
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width = 0.5 \textwidth]{figures/voronoi_performance}
	\end{center}
	\caption[Voronoi calculation performance.]{
		...
		number of random line segments using the \textit{Boost.Polygon} (``Boost'') \cite{web_boost_polygon}
