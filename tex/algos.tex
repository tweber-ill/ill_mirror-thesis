...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width = 0.4 \textwidth]{figures/rtree8}
		\hspace{1cm}
		\includegraphics[width = 0.4 \textwidth]{figures/rstartree8}
	\end{center}
...
readily available \cite{TODO}. Unfortunately and surprisingly, the \textit{Boost} C++ libraries \cite{web_boost},
