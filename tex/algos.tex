...
cell for which all physics is the same, the so-called \textit{first Brillouin zone} of the reciprocal
lattice \cite[pp. 63-64]{Gross2012}, whose definition corresponds to that of the Voronoi region.
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width = 0.75 \textwidth]{figures/bz}
	\end{center}
