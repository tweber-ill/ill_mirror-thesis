...
$k_{i,f} = 2\pi / \lambda_{i}$ and are rotated by $2\theta_S$ from one another, see Fig. \ref{fig:diffraction} for a visualisation.
...
\begin{figure}[htb]
	...
	\caption[The Thales instrument at the ILL.]{
		...
		Similar figures, albeit showing different instruments, have been published in my doctoral
