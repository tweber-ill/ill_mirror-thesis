...
After some general introduction, two chapters provide the necessary building blocks for the
...
as well as chapter \ref{ch:algos}, which presents data structures and algorithms that are necessary for
the path-finding.
...
Chapter \ref{ch:gl} contains a brief introduction to the math of three-dimensional computer graphics, which
is made use of in chapter \ref{ch:gui}, that is concerned about the user interfaces to the software
developed in this work. These user interfaces include a graphical one based on an interactive, three-dimensional
