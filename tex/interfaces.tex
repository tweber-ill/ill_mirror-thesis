...
to the near and far planes of view frustum into the global object coordinate system and finding all objects
that intersect with a line through these two unprojected points. 
