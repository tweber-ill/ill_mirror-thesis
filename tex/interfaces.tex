...
Using the $UB$ transformation matrix that has been set up before (section \ref{sec:gui_xtal}),
...
is kept constant and which is variable to effectuate the energy transfer.
